...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function start() {
      ...
      fetch("https://maccusnick.github.io/data-mock/nick-music/music-list.json").then(function (res) {
        return res.json();
      }).then(function (data) {
    ...
    value: function setLyrics(lyrics) {
      ...
      this.$(".panel-lyric .container").innerHTML = "";
      this.$(".panel-lyric .container").appendChild(fragment);
    }
  }, {
    key: "setLyricToCenter",
    value: function setLyricToCenter(node) {
      var translateY = node.offsetTop - this.$(".panel-lyric").offsetHeight / 2;
      translateY = translateY > 0 ? translateY : 0;
      this.$(".panel-lyric .container").style.transform = "translateY(-".concat(translateY, "px)");
      this.$$(".panel-lyric p").forEach(function (node) {
